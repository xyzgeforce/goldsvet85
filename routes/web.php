    ...
    ->middleware(['auth', 'checker'])->group(function ()
{
    Route::namespace ('Backend')->group(function ()
    {
        ...
        Route::get('/withdraw/approve', ['as' => 'backend.withdraw.approve', 'uses' => 'DashboardController@withdraw_approve', ]);
        Route::get('/withdraw/reject',  ['as' => 'backend.withdraw.reject', 'uses' => 'DashboardController@withdraw_reject', ]);
