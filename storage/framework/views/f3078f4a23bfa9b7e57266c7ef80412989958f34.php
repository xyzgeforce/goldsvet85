...
<head>
	...
	<script>
		...
		var qstr='/?g=KingOctopus&p=x&u=237558600&t=123&ak=accessKey&cr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&loc=en';	
...
</html><?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/KingOctopusKA.blade.php ENDPATH**/ ?>