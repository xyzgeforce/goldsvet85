...
<body>
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		if(CDNADDRESS) {
			...
			CDNADDRESS =  location.protocol + '//' + location.hostname +"/games/<?php echo e($game->name); ?>/game/";

		}

        

        var SELSVRURL = location.protocol + '//' + location.hostname + '/game/<?php echo e($game->name); ?>/server?sessionId='+sessionStorage.getItem('sessionId'); // 选服接口
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/LegendOfThePhoenixVP.blade.php ENDPATH**/ ?>