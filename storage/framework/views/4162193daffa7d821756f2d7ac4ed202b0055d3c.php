...
document.location.href=exitUrl;	
	...
	return 4;
		...
		document.location.href=document.location.href+'/?game=lightninghot&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>';	
		}else{
	/*------------------------------------------------*/
...
</html><?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/LightingHotAM.blade.php ENDPATH**/ ?>