...
<iframe id='game' style="margin:0px;border:0px;width:100%;height:100vh;" src='/games/RomanLegionAM/amarent/index.html?game=romanlegion&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>' allowfullscreen>
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/RomanLegionAM.blade.php ENDPATH**/ ?>