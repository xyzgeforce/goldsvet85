                                    ...
                                    <a class="providers-mob__link providers-mob__link--exclusive" scroll-up="" href="<?php echo e(route('frontend.game.list.category', $category->href)); ?>">
                                        <span class="providers-mob__icon-wrp">
                                            <span class="providers-mob__icon">
                                                <img class="providers-mob__icon-img providers-mob__icon-img--pragmaticplay" src="https://cdn2.softswiss.net/woocasino/logos/providers_small/color/<?php echo e($category->href); ?>.svg">
                                            </span>
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/Default/partials/navbar.blade.php ENDPATH**/ ?>