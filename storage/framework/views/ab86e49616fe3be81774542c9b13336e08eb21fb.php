...
if(document.location.href.split("?api_exit")[1]!=undefined){
		...
		document.location.href=uparts[0]+'/?game=keno&hash=&lang=en&protokol=wss&server=&port=&socket=&exit=&balanceInCash=1&m=&w=w1&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&'+uparts[1];	
		}
...
</html><?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/BingoAM.blade.php ENDPATH**/ ?>