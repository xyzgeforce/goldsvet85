...
document.cookie = 'PHPSESSID=; Max-Age=0; path=/; domain=' + location.host;
 ...
 window.onerror=function(){return true};
    ...
    if( !sessionStorage.getItem('sessionId') ){
		...
		document.location.href=document.location.href+'/?hash=&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&lang=ru&uselang=en&exit=&config=1372';	
		}else if(document.location.href.split("?api_exit")[1]!=undefined){
			
		document.location.href=uparts[0]+'/?hash=&curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&lang=ru&uselang=en&exit=&config=1372&'+uparts[1];	
		}
...
</html><?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/DoubleDoubleBonusAM.blade.php ENDPATH**/ ?>