...
<!-- SIDEBAR -->
    ...
    <ul class="list-unstyled components">
						...
						<?php if($categories && count($categories)): ?>
							...
							<li  data-category="<?php echo e($category->id); ?>">
									<a href="javascript: void(0);">
        ...
        <div class="col-10 col-sm-6 text-sm-right text-center">
            <div class="btn primary-btn d-inline-block mt-1 user-info">
							<span class="custom-input-group-icon text-left" style="margin-right: 10px;" data-toggle="tooltip"
								...
								<span id="user-username"><?php echo e(Auth::user()->username); ?></span>
							</span>
                <span class="custom-input-group-icon text-left" style="margin: 10px;" id="hideMsg" data-toggle="tooltip"
                      title="Balance">
								<i class="fas fa-wallet"></i>
								<span id="user-balance"><?php echo e(number_format(Auth::user()->balance, 2,".",",")); ?> <?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?></span>
							</span>
                ...
                <span class="custom-input-group-icon text-left" style="margin-left: 10px;" data-toggle="tooltip"
                      title="Bonus">
								...
								<span id="user-cashback"><?php echo e(number_format(Auth::user()->count_return, 2,".",",")); ?> <?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?></span>
							</span>
        ...
        <nav class="navbar navbar-expand p-0 scrollable-navbar">
            <div>
                <ul class="navbar-nav">
									...
									<?php if($categories && count($categories)): ?>
										<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(!in_array($category->href, $companies)): ?>
										<li class="nav-item" data-sv="<?php echo e($category->href); ?>" data-category="<?php echo e($category->id); ?>">
												<a class="nav-link text-center" href="javascript: void(0);">
														<?php echo e($category->title); ?>
							...
							<nav class="navbar navbar-expand p-0 scrollable-navbar" id="vendors">
								<ul class="navbar-nav">
									<?php if($categories && count($categories)): ?>
										<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(in_array($category->href, $companies)): ?>
										<li class="nav-item mr-2 ml-2 box active" data-category="<?php echo e($category->id); ?>">
											<a href="javascript: void(0);"><img style="filter:brightness(0) invert(1);" class="nav-item-img" src="/frontend/Tropicoblack/img/companies/<?php echo e($category->href); ?>.png"></a>
										</li>
										<?php endif; ?>
...
<script>
	...
	var GLOBAL_GAMES_LIST = [
		...
		<?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		{
			...
			"launchUrl":"/game/<?php echo e($game['name']); ?>?api_exit=/",
			"providerId":"bomba",
			"categoryName":"<?php echo e(\VanguardLTE\GameCategory::where('game_id',$game->original_id)->first()->category_id); ?>",
			"gameName":"<?php echo e($game['title']); ?>",
			"imageUrl":"<?php echo e($game->name ? '/frontend/Tropicoblack/ico/' . $game->name . '.jpg' : ''); ?>",
			"data-src":"<?php echo e($game->name ? '/frontend/Tropicoblack/ico/' . $game->name . '.jpg' : ''); ?>",
			"mobileGame": false
		},
...
<script>
    ...
    var SUCCESS = "Success!";
		...
		var jackpotSettings = {
		    "jackpot-elem1": {
		        currentValue: <?php echo e($jpgs[0]->balance); ?>,
		        isRed: false,
		        details: {
		            bigger_win: {
		                amount: 100,
		    ...
		    "jackpot-elem2": {
		        currentValue: <?php echo e($jpgs[1]->balance); ?>,
		        isRed: true,
		        details: {
		            bigger_win: {
		                amount: 100,
				...
				?>
		    "jackpot-elem3": {
		        currentValue: <?php echo e($jpgs[2]->balance); ?>,
		        isRed: false,
		        details: {
		            bigger_win: {
		                amount: 100,
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/Tropicoblack/layouts/app.blade.php ENDPATH**/ ?>