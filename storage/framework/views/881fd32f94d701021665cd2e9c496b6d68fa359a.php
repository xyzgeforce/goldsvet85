...
<iframe id='game' style="position:fixed;top:0px;margin:0px;border:0px;width:100%;height:100vh;" src='/games/Dynamite7AM/mobile/dynamite7.html/?curr=<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>&lang=en&w=&lang=en' allowfullscreen>
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/Dynamite7AM.blade.php ENDPATH**/ ?>