...
<header class="header">
    <div class="header__mob-container">
        <div class="header__logo">
            <a class="header__logo-link" scroll-up="" href="#"> <img class="header__logo-img" src="/woocasino/resources/images/logo.png" alt=""> </a>
        </div>
                ...
                <div class="popup__cont " id="div_history">
                    ...
                    <div class="history__box">
                            ...
                            <div class="history__cont">
                                <table class="table table--history">
                                    ...
                                    <tr>
                                        <td class="table__num">#</td>
                                        <td class="table__date"><?php echo app('translator')->get('app.date_date'); ?></td>
                                        <td class="table__deposit"><?php echo app('translator')->get('app.amountsum'); ?></td>
                                    ...
                                    <?php if(isset($withdrawlist) && count($withdrawlist)): ?>
                                        <?php $__currentLoopData = $withdrawlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($row->status ? ($row->status == 2 ? 'Approve' : 'Reject') : 'Pending'); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <tr><td colspan="6"><?php echo app('translator')->get('app.nwithdrawal_date'); ?></td></tr>
                                    <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <?php if( settings('payment_pin') ): ?>
                            <div class="history__item">
                                <div class="history__name"><?php echo app('translator')->get('app.pincode'); ?></div>
                                <div class="history__cont">
                                    <table class="table table--history">
                                        <thead>
                                        <tr>
                                            <td class="table__num">#</td>
                                            <td class="table__date"><?php echo app('translator')->get('app.date_date'); ?></td>
                                            <td class="table__game"><?php echo app('translator')->get('app.pincode'); ?></td>
                                            <td class="table__deposit"><?php echo app('translator')->get('app.nominal'); ?></td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(isset($pincodeslist) && count($pincodeslist)): ?>
                                            <?php $__currentLoopData = $pincodeslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($k+1); ?></td>
                                                    <td><?php echo e(date('Y-m-d H:i', strtotime($row->created_at))); ?></td>
                                ...
                                <?php echo Form::open(['route' => 'frontend.balance.post', 'method' => 'POST']); ?>
                                    ...
                                    <div class="modal__content contentpay">
                                        <div class="deposit__inner" style="grid-template-columns: 35% 55%;">
                                            <div class="input">
                                                <button style="min-width: 100%;" class="popup__button button"><?php echo app('translator')->get('app.amountsum'); ?></button>
                                            </div>
                                            <div class="modal__input input">
                                                <input type="text" name="summ" class="modal__input-inner input__inner" placeholder="0" required="" style="width:100%">
                                            </div>
                                        </div>
                                        <div class="input" style="display:grid">
                                            <input type="hidden" name="system" value="coinbase">
                                            <button type="submit" name="description" value="Pay balance" class="popup__button button"><?php echo app('translator')->get('app.topup_date'); ?></button>
                                        </div>
                                    </div><div class="popup__warn" style="font-size:16px; align:center; "><?php echo app('translator')->get('app.minimum_payment_amount'); ?> 10 EUR/USD</div>
                                <?php echo Form::close(); ?>
                    ...
                    <?php if( settings('payment_pin') ): ?>
                        <div class="deposit__item">
                            <div class="deposit__box">
                                ...
                                <div class="deposit__payments">
                                    <!-- <img src="/frontend/Default/img/_src/logo-kassa-4.png" alt="" class="deposit__payments-img" style="height: 100%;"> -->
                                </div>
                            </div>
                            <div class="deposit__cont" style="overflow: hidden; display: none;">
                                <?php echo Form::open(['route' => 'frontend.profile.pincode', 'method' => 'GET']); ?>

                                    <div class="modal__content contentpay">
                                        <div class="deposit__inner" style="grid-template-columns: 35% 55%;">
                                            <div class="input">
                                                <button style="min-width: 100%;" class="popup__button button"><?php echo app('translator')->get('app.pincode'); ?></button>
                                            </div>
                                            <div class="modal__input input">
                                                <input type="text" name="pincode" class="modal__input-inner input__inner" placeholder="" required="" style="width:100%">
                                            </div>
                                        </div>
                                        <div class="input" style="display:grid">
                                            <button type="submit" value="Activate" class="popup__button button"><?php echo app('translator')->get('app.activatepincode'); ?></button>
                                        </div>
                                    </div>
                                <?php echo Form::close(); ?>
                    ...
                    <?php echo Form::open(['route' => 'frontend.profile.withdraw', 'method' => 'POST']); ?>
                        ...
                        <div class="modal__content">
                            ...
                            <div class="deposit__inner">
                                <div class="modal__input input">
                                    <input type="text" name="txtamount" placeholder="0" class="modal__input-inner input__inner" style="">
                                </div>
                                <div class="modal__input input">
                                    <select name="txtcurrency" class="modal__input-inner input__inner" style="width: 200px;">
                                        
										<option value="USD">Bank Card EUR</option>
										<option value="USD">Bank Card USD</option>
									    <option value="USD">Bank Card RUB</option>
										<option value="USD">Paypal</option>
										<option value="EUR">USDT trc-20</option>
                                        <option value="USD">USDC trc-20</option>
										<option value="USD">Doge coin</option>
                            ...
                            <div style="display: grid;grid-template-columns: 1fr;">
                                <div class="modal__input input">
                                    <input type="text" name="wallet" placeholder="<?php echo app('translator')->get('app.cardwallet'); ?>" class="modal__input-inner input__inner" style="width: 100%; text-align: center;" required>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/Default/partials/header_logged.blade.php ENDPATH**/ ?>