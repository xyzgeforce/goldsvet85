...
<?php $__env->startSection('content'); ?>
  ...
  <tbody>
                        <?php if(count($users)): ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php else: ?>
                            <tr><td colspan="6"><?php echo app('translator')->get(''); ?></td></tr>
                        <?php endif; ?>
                        </tbody>
                        <thead>
                        <tr>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\resources\views/backend/user/tree.blade.php ENDPATH**/ ?>