...
<html lang="ru">
 ...
 2px 2px 2px rgba(255,255,255,0.25);
  ...
  window.init_loader({
    ...
    kf: 100,
    currency: "<?php if( auth()->user()->present()->shop ): ?><?php echo e(auth()->user()->present()->shop->currency); ?><?php endif; ?>",
    language: "en_US",
    home_page: '/',
    button: "classic"
  });
...
<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/games/list/DuckyPowerBallKenoRS.blade.php ENDPATH**/ ?>