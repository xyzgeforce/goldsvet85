                        ...
                        <nav class="category-panel__menu games-menu ng-isolate-scope" name="games_menu">
                            <ul class="games-menu__list">
                                <li class="games-menu__item games-menu__item--bitcoin">
                                    <a class="games-menu__link games-menu__link--bitcoin" href="<?php echo e(route('frontend.game.list.category', 'all')); ?>"> <i class="games-menu-icon games-menu-icon"></i> <span class="games-menu__title ng-scope"><?php echo app('translator')->get('app.all'); ?></span> </a>
                                </li>
                                ...
                                <li class="providers__item ng-scope">
                                    <a class="providers__link" scroll-up="" href="<?php echo e(route('frontend.game.list.category', $v)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--<?php echo e($v); ?>" alt="<?php echo e($v); ?>" src="../woocasino/images/providers/<?php echo e($v); ?>.png">
                                        </span>
                            ...
                            <?php if($categories && count($categories)): ?>
                                ...
                                <li class="providers__dropdown-item ng-scope">
                                    <a class="providers__link" href="<?php echo e(route('frontend.game.list.category', $category->href)); ?>">
                                        <span class="providers__icon">
                                            <img class="providers__icon-img providers__icon-img--1x2gaming" alt="" src="../woocasino/images/providers/<?php echo e($category->href); ?>.png">
                                        </span>
...
<?php echo $__env->make('frontend.Default.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/Default/games/list.blade.php ENDPATH**/ ?>