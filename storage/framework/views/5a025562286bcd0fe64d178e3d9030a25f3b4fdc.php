...
<?php if(settings('forgot_password') || true): ?>
    <div class="modal" id="restore-password" style="display: none">
        <header class="modal__header">
            <div class="span modal__title"><?php echo app('translator')->get('app.forgot_your_password'); ?></div>
        ...
        <form ng-submit="sendForm($event)" action="<?= route('frontend.password.remind.post') ?>" method="POST"
            ...
            <div class="popup__footer">
                <input type="submit" value="<?php echo app('translator')->get('app.reset_your_password'); ?>" class="popup__button button" />
            </div>
        </form>
                    ...
                    <div class="registry-modal__content">
                        <div class="registry-modal__content-txt">
                            ...
                            <div class="ng-binding ng-scope ng-isolate-scope">
                                <h2 class="registry-modal__content-title registry-modal__content-title--desktop">
                                    <span class="registry-modal__content-title-small"></span>
                                    <span class="registry-modal__content-rows-wrp">
                                        <span class="registry-modal__content-title-big text-color-yellow"></span>                                <span class="registry-modal__content-title-small "></span>
                                    </span>
                                </h2>
                                <h2 class="registry-modal__content-title registry-modal__content-title registry-modal__content-title--mob">
                                    <span class="registry-modal__content-title-small"></span>
                                    <span class="registry-modal__content-rows-wrp">
                                        <span class="registry-modal__content-title-big text-color-yellow"></span>
                                        <span class="registry-modal__content-title-small registry-modal__content-title-small--mob-decor"></span>
                                    </span>
                                </h2>
                            </div>
                        </div>
                        ...
                        <ul class="registry-modal__steps registry-modal__steps--1">
                            <!--<li class="registry-modal__item registry-modal__item--1 registry-modal__item--current">
                                <span class="registry-modal__item-txt ng-scope"></span>
                            </li>
                            ...
                            <li class="registry-modal__item registry-modal__item--3">
                             ...
                             <li class="registry-modal__item registry-modal__item--prize">
                                <div class="ng-binding ng-isolate-scope ng-scope">
                                    <span class="registry-modal__item-txt-big"></span>
                                    <span class="registry-modal__bonus-text-shine"></span>
                                    <span class="registry-modal__bonus-text-mob"></span>
                                </div>
                                <span class="registry-modal__no-bonus ng-scope"></span>
                            </li> -->
                        </ul>
                    </div>
                                ...
                                <div class="form__step form__step--1">
                                    ...
                                    <div class="form__field form__field--age_terms_acceptance form__field--checkbox">
                                        <label class="checkbox-elem">
                                            <input class="checkbox-elem__input ng-pristine ng-untouched ng-valid ng-empty" type="checkbox" placeholder="" checked>
...
<div class="modal" id="system-notification-success" style="display:none">
        ...
        <div class="popup__footer">
                <input ng-click="closeModal($event)" type="submit" value="Close" class="popup__button button" onclick="location.reload();" />
        </div>
</div>

<?php /**PATH /var/www/fastuser/data/www/demo60.2games.pw/resources/views/frontend/Default/partials/popups.blade.php ENDPATH**/ ?>