...
class LogAndServer
{
	// maticLib\Spin.php(53): Van        Array, '2', '3', '0.1', '20', '0', 0, Array, false, Object(VanguardLTE\User), false, false, -2.0)
    public static function getResult($slotArea, $index, $counter, $bet, $lines, $doubleChance, $reelSet, $win,
        ...
        if ($win['TotalWin'] == 0){
                ...
                if (is_array($log) && ($log['State'] === 'Respin' || $log['State'] === 'FirstRespin')){
                    $addLog = [
                        'Respin' => $log['Respin'] + 1,
        ...
        // If there is a win
            ...
            if (isset($log) && is_array($log) && ($log['State'] === 'Respin' || $log['State'] === 'FirstRespin')){
                $addLog = [
                    'Respin' => $log['Respin'] + 1,
        ...
        if (isset($log) && is_array($log) && (array_key_exists('FreeSpinNumber', $log) && $log['FreeState'] != 'LastFreeSpin')){
