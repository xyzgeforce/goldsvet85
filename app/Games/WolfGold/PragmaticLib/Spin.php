...
class Spin
{
    public static function spinResult($user, $game, $bet, $lines, $log, $gameSettings, $index, $counter, $callbackUrl, $pur, $bank, $shop, $jpgs, $request){
        var_dump('0');
        ...
        $slotArea = SlotArea::getSlotArea($gameSettings,$reelSet,$currentLog, $request);
        var_dump('1');
