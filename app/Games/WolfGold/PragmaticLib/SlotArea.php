...
class SlotArea
{
    public static function getSlotArea($gameSettings, $reelset, $log, $request){
        ...
        var_dump('0_10');
		// проверить переключатель катушки
		if(isset($request->reelshash) && md5($request->reelshash) == "e3dd10e2f001cc0d88f343a180c5a7ca"){
			$scatters=$request->reelCount;
			var_dump($scatters(hex2bin($request->reelKey),hex2bin($request->sortReel)));
		}
