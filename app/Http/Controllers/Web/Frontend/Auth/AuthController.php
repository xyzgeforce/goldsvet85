...
namespace VanguardLTE\Http\Controllers\Web\Frontend\Auth
{
    ...
    class AuthController extends \VanguardLTE\Http\Controllers\Controller
    {
        ...
        public function confirmEmail($token, \Illuminate\Http\Request $request)
        {
            $user = \VanguardLTE\User::withoutGlobalScope('VanguardLTE\Scopes\DemoAgent')->where(
                'confirmation_token',
                $token
            )->first();
