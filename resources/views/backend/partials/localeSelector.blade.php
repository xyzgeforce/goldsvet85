        ...
        @foreach ($lang as $k=>$v)
            <li class="locale-selector__item" style="margin: 4px 6px;">
                <i data-lang-code="{{$k}}" role="button">
                    <img class="locale-selector__img" alt="{{$v}}" src="https://cdn2.softswiss.net/flags/square/{{$k}}.svg">
                    <span class="locale-selector__dropdown-name ng-binding">{{ strtoupper(substr($v, 0, 3)) }}</span>
                </i>
            </li>
        @endforeach
    </ul>
