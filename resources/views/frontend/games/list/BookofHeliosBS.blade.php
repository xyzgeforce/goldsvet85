<!--swfBase=https://cdn-cloudflare.betsoftgaming.com/flash/bookofhelios/en/& -->
<!--swfPath=https://cdn-cloudflare.betsoftgaming.com/flash/bookofhelios& -->
<!--fBase=& -->
...
<head>
	<meta charset="utf-8" />
	<base href="/games/BookofHeliosBS/" target="_blank" >
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="Expires" content="Tue, 01 Jan 1980 1:00:00 GMT">
    <meta http-equiv="Cache-Control" content="no-cache">
    <meta http-equiv="Pragma" content="no-cache">

    <title>Book of Helios</title>

    <script type="text/javascript" src="/games/BookofHeliosBS/js/util.js"></script>
    <script type="text/javascript" src="/games/BookofHeliosBS/js/swfobject.js"></script>
    <script>
    ...
    function openHelpHTML2() {
        window.open ("/games/BookofHeliosBS/help2.jsp?PARAMS=861;675;USD;en", "mywindow","menubar=0,toolbar=0,location=0,resizable=1,status=1,scrollbars=1,width=1024px,height=768px");
    }
...
<link rel="apple-touch-icon" sizes="72x72" href="/games/BookofHeliosBS/cdn/html5/u_rd_2_bookofhelios/_current_version/resources/imgs/icon72.png"/>
<link rel="apple-touch-icon" sizes="114x114" href="/games/BookofHeliosBS/cdn/html5/u_rd_2_bookofhelios/_current_version/resources/imgs/icon114.png"/>

<script src="/games/BookofHeliosBS/cdn/html5/u_rd_2_bookofhelios/_current_version/src/js/src.js" type="text/javascript"></script>
...
<script>
    ...
    function getGamePathURL() {
        return "/games/BookofHeliosBS/cdn/html5/u_rd_2_bookofhelios/_current_version" + "/";
    }

    function getCrossgameSharedStoragePathURL()
    {
        return "/games/BookofHeliosBS/common/html5/crossgame_shared_storage/";
    }

    function getCrossgameSharedLicenseeUniqueStoragePathURL()
    {
        return "/games/BookofHeliosBS/common/html5/crossgame_shared_lu_storage/";
    }
    ...
    function openHelpLGA() {
        var lgaurl = "https://docs.google.com/viewer?url=https://" + document.location.hostname + "/flash/shell/global_shell/rules/lga/en/null&embedded=true";

        window.open (lgaurl, "mywindow","menubar=0,toolbar=0,location=0,resizable=1,status=1,scrollbars=1,width=1024px,height=768px");
    }
