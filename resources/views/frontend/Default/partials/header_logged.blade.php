                ...
                <div class="popup__cont " id="div_history">
                    ...
                    <div class="history__box">
                            ...
                            <div class="history__cont">
                                <table class="table table--history">
                                    ...
                                    <tr>
                                        <td class="table__num">#</td>
                                        <td class="table__date">@lang('app.date_date')</td>
                                        <td class="table__deposit">@lang('app.amountsum')</td>
                                    ...
                                    @if (isset($withdrawlist) && count($withdrawlist))
                                        @foreach ($withdrawlist as $k => $row)
                                            <tr>
                                                ...
                                                <td>{{ $row->status ? ($row->status == 2 ? 'Approve' : 'Reject') : 'Pending' }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr><td colspan="6">@lang('app.nwithdrawal_date')</td></tr>
                                    @endif
                                    </tbody>
                                </table>
                            </div>
                        ...
                        @if( settings('payment_pin') )
                            <div class="history__item">
                                <div class="history__name">@lang('app.pincode')</div>
                                <div class="history__cont">
                                    <table class="table table--history">
                                        <thead>
                                        <tr>
                                            <td class="table__num">#</td>
                                            <td class="table__date">@lang('app.date_date')</td>
                                            <td class="table__game">@lang('app.pincode')</td>
                                            <td class="table__deposit">@lang('app.nominal')</td>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if (isset($pincodeslist) && count($pincodeslist))
                                            @foreach ($pincodeslist as $k=>$row)
                                                <tr>
                                                    <td>{{ $k+1 }}</td>
                                                    <td>{{ date('Y-m-d H:i', strtotime($row->created_at)) }}</td>
                                                    <td>{{ $row->title }}</td>
                   ...
                   <!-- <div class="bonus">
                                ...
                                {!! Form::open(['route' => 'frontend.balance.post', 'method' => 'POST']) !!}
                                    <div class="modal__content contentpay">
                                        <div class="deposit__inner" style="grid-template-columns: 35% 55%;">
                                            <div class="input">
                                                <button style="min-width: 100%;" class="popup__button button">@lang('app.amountsum')</button>
                                            </div>
                                        ...
                                        <div class="input" style="display:grid">
                                            ...
                                            <button type="submit" name="description" value="Pay balance" class="popup__button button">@lang('app.topup_date')</button>
                                        </div>
                                    </div><div class="popup__warn" style="font-size:16px; align:center; ">@lang('app.minimum_payment_amount') 10 EUR/USD</div>
                                {!! Form::close() !!}
                            </div>
                        </div>
                    @endif
                    ...
                    @if( settings('payment_pin') )
                        <div class="deposit__item">
                            ...
                            <div class="deposit__cont" style="overflow: hidden; display: none;">
                                {!! Form::open(['route' => 'frontend.profile.pincode', 'method' => 'GET']) !!}
                                    <div class="modal__content contentpay">
                                        <div class="deposit__inner" style="grid-template-columns: 35% 55%;">
                                            <div class="input">
                                                <button style="min-width: 100%;" class="popup__button button">@lang('app.pincode')</button>
                                            </div>
                                            <div class="modal__input input">
                                        ...
                                        <div class="input" style="display:grid">
                                            <button type="submit" value="Activate" class="popup__button button">@lang('app.activatepincode')</button>
                                        </div>
                                    </div>
                                {!! Form::close() !!}
                            </div>
                    ...
                    {!! Form::open(['route' => 'frontend.profile.withdraw', 'method' => 'POST']) !!}
                        <div class="modal__content">
                            ...
                            <div style="display: grid;grid-template-columns: 1fr;">
                                <div class="modal__input input">
                                    <input type="text" name="wallet" placeholder="@lang('app.cardwallet')" class="modal__input-inner input__inner" style="width: 100%; text-align: center;" required>
                                </div>
                            </div>
                        </div>
